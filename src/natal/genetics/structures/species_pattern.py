"""Species genotype and haploid genome pattern matching methods."""
...
def _species_resolve_single_genotype_selector(
    self: Species,
...
def _species_resolve_genotype_selectors(
    self: Species,
...
def _species_parse_genotype_pattern(self: Species, pattern: str) -> Callable[[Genotype], bool]:
    """
...
def _species_filter_genotypes_by_pattern(
    self: Species,
...
def _species_enumerate_genotypes_matching_pattern(
    self: Species,
    pattern: str,
...
def _species_parse_haploid_genome_pattern(self: Species, pattern: str) -> Callable[[HaploidGenome], bool]:
    """
...
def _species_filter_haploid_genomes_by_pattern(
    self: Species,
...
def _species_enumerate_haploid_genomes_matching_pattern(
    self: Species,
    pattern: str,
    max_count: Optional[int] = None
...
Species.enumerate_genotypes_matching_pattern = _species_enumerate_genotypes_matching_pattern  # pyright: ignore[reportAttributeAccessIssue]
Species.parse_haploid_genome_pattern = _species_parse_haploid_genome_pattern  # pyright: ignore[reportAttributeAccessIssue]
Species.filter_haploid_genomes_by_pattern = _species_filter_haploid_genomes_by_pattern  # pyright: ignore[reportAttributeAccessIssue]
Species.enumerate_haploid_genomes_matching_pattern = _species_enumerate_haploid_genomes_matching_pattern  # pyright: ignore[reportAttributeAccessIssue]
