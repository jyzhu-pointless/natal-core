"""Config builders, map initialisers, and helper utilities.

This private module contains the factory functions that construct
``PopulationConfig`` and ``DiscretePopulationConfig`` instances from raw
parameters, as well as map initialisation and compression helpers.
"""
