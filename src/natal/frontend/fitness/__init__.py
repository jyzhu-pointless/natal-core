...
if TYPE_CHECKING:
    from natal.frontend.fitness._patch import apply_preset_fitness_patch  # noqa: F401
    from natal.frontend.fitness._writer import write_fitness_field  # noqa: F401


def __getattr__(name: str) -> object:
    """Lazy-load public symbols to avoid circular imports at package-init time."""
    if name == "apply_preset_fitness_patch":
        from natal.frontend.fitness._patch import apply_preset_fitness_patch as _fn
        return _fn
    if name == "write_fitness_field":
        from natal.frontend.fitness._writer import write_fitness_field as _fn
        return _fn
