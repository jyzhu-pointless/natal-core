...
(:class:`~natal.frontend.genetics.structures.chromosome.Chromosome` and
:class:`~natal.frontend.genetics.structures.species.Species`).
"""
...
if TYPE_CHECKING:
    from natal.frontend.genetics.structures.locus import Locus

    from .gene import Gene

# Runtime imports for structure_type assignment
from natal.frontend.genetics.structures.chromosome import Chromosome  # noqa: E402
from natal.frontend.genetics.structures.species import Species  # noqa: E402
