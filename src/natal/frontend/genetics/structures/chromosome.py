...
single chromosome that groups multiple :class:`~natal.frontend.genetics.structures.locus.Locus`
...
class Chromosome(GeneticStructure['Haplotype']):  # pyright: ignore[reportUndefinedVariable]
    ...
    def entity_type(self):
        ...
        Returns:
            The :class:`~natal.frontend.genetics.entities.haplotype.Haplotype` class.
        """
