...
:class:`~natal.frontend.genetics.structures.chromosome.Chromosome` instances, each
...
if TYPE_CHECKING:
    ...
    from natal.frontend.genetics.entities.haplotype import (
...
class Species(
    ...
    def entity_type(self) -> type[HaploidGenome]:
        ...
        Returns:
            The :class:`~natal.frontend.genetics.entities.haplotype.HaploidGenome` class.
        """
    ...
    def clear_entity_cache(self) -> None:
        ...
        from natal.frontend.genetics.entities._base import GeneticEntity
